...
export default function Map() {
  ...
  return (
    <div className=" border-y-[0.5px] border-gray-400 p-1 pt-4 w-[50vw] h-[400px] overflow-hidden shadow-lg">
      <MapContainer
        center={[30.7128, 76.0060]}
        zoom={9}
